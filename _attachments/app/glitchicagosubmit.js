...
$((function() {
  // LIST OUT LINEUP
  $.ajax({
    url: 'http://0p3nr3p0.net/_view/glitchicago',
    type: 'get',
    dataType: 'jsonp',
  ...
  $("#create-link").submit(function(e) {
    ...
    if (valid === true) {
      ...
      db.saveDoc(doc, {
        ...
        error: function() {
          alert("This link is already in the repo! Please use your original edit URL to add it to the Sudlab show.")
        }
      });
    } else {
